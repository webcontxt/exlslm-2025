...
/// SuspensionView.
class AZSuspensionView extends StatefulWidget {
  AZSuspensionView({
    Key? key,
    required this.data,
  ...
  @override
  _AZSuspensionViewState createState() => _AZSuspensionViewState();
}

class _AZSuspensionViewState extends State<AZSuspensionView> {
