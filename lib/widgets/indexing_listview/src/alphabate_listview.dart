import 'package:dreamcast/widgets/indexing_listview/src/az_common.dart';
import 'package:flutter/material.dart';
import 'package:scrollable_positioned_list/scrollable_positioned_list.dart';
import 'index_bar.dart';
import 'suspension_view.dart';
/// AzListView
class AlphabateListview extends StatefulWidget {
  AlphabateListview({
    Key? key,
    required this.data,
  ...
  @override
  _AlphabateListviewState createState() => _AlphabateListviewState();
}

class _AlphabateListviewState extends State<AlphabateListview> {
