      ...
      body: SafeArea(
          child: Container(
              ...
              padding: const EdgeInsets.only(
                  top: 16, bottom: 10, right: 15, left: 15),
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                if (controller.userFilterBody.value.sort !=
                                    null)
                                  _buildSortWidget(
                                ...
                                if (controller.userFilterBody.value.isBlocked !=
                                    null)
                                  _buildFilterBlock(controller
                                      .userFilterBody.value.isBlocked),
                                if (controller.userFilterBody.value.notes !=
                                    null)
                                  _buildFilterNotes(
                      ...
                      child: CommonMaterialButton(
                        ...
                        onPressed: () async {
                          if (controller.isReset.value) {
                            controller.tempFilterBody(
                                controller.userFilterBody.value);
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (filter != null) _buildSelectedOption(filter),
